...
//														return x.ToString();
//													});
			var result = numbers.Select(delegate(int x)
			{
				return x.ToString();
			});
...
//														return x.ToString();
//													});
			var anonymous = numbers.Select(delegate(int x) { return x.ToString(); });
...
//														return x.ToString(); 
//													});
			var lambda = numbers.Select((int x) => { return x.ToString(); });
...
//														return x.ToString();
//													});
			var lambda = numbers.Select((x) => { return x.ToString(); });
			Assert.Equal(FILL_ME_IN, anonymous);
		}
...
//			var lambda = Array.ConvertAll(numbers, x => x.ToString());
			var lambda = numbers.Select(x => x.ToString());
